...
func problems(numberOfProblems: Int) {
	print("I got \(numberOfProblems) but Swift aint one")
}
...
madLib("Annoying Dog", noun: "House", preposition: "of")
/*: question10
...
func infinity(characterName: String) -> String {
	return "To inifinity and beyond, \(characterName.uppercaseString)"
}
